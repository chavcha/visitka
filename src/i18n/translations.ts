...
const en: Copy = {
  ...
  terminal: {
    welcome: 'Welcome to vs-terminal. Type help to see commands.',
    hint: 'Try: help · skills · contact · github · clear',
    ...
    contactGithub: '  github:   github.com/chavcha',
    contactPhone: '  phone:    +7 (918) 488-34-24',
    githubOpen: 'Opening github.com/chavcha …',
...
const ru: Copy = {
  ...
  terminal: {
    welcome: 'Добро пожаловать в vs-terminal. Введите help для списка команд.',
    hint: 'Попробуйте: help · skills · contact · github · clear',
    helpTitle: 'Доступные команды:',
    helpLines: [
      '  help     — показать этот список',
      '  skills   — стек технологий',
      '  contact  — email, Telegram, телефон',
    ...
    contactGithub: '  github:   github.com/chavcha',
    contactPhone: '  phone:    +7 (918) 488-34-24',
    githubOpen: 'Открываю github.com/chavcha …',
